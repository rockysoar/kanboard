...
return array(
    ...
    'Category:' => '项目：',
    'Categories' => '项目',
    'Your category have been created successfully.' => '成功为您创建项目。',
    'This category has been updated successfully.' => '成功为您更新项目。',
    'Unable to update this category.' => '无法为您更新项目。',
    'Remove a category' => '移除一个项目',
    'Category removed successfully.' => '项目成功移除。',
    'Unable to remove this category.' => '无法移除该项目。',
    'Category modification for the project "%s"' => '为项目"%s"修改分类',
    'Category Name' => '项目名称',
    'Add a new category' => '加入新项目',
    'Do you really want to remove this category: "%s"?' => '确定要移除项目"%s"吗？',
    'All categories' => '所有项目',
    'No category' => '通用项目',
