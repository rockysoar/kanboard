<div class="sidebar sidebar-icons">
    ...
    <ul>
       ...
       <li>
            <a href="http://wiki.office.51fanli.com/wiki/<?=str_replace(['#', ' ', '::'], '-', str_replace(' #','', $task['title']))?>" target=_blank>
            <i class="fa fa-wiki fa-fw js-modal-large" aria-hidden="true"></i>编辑wiki
            </a>
        </li>
